...
We also need to specify a hash. To get this hash, you can run `zig fetch <url>`. For example, `zig fetch https://github.com/raysan5/raylib/archive/52f2a10db610d0e9f619fd7c521db08a876547d0.tar.gz` returns `1220761aef32a253042bf79d5acc4c2013853f4db5a9a9f68cd341ee4ddb9099803a`. Update your `build.zig.zon` with this hash as follows:
